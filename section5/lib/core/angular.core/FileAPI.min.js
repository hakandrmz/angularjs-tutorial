...
!function (a) {
    ...
    var m = 1, n = function () {
    }, o = a.document, p = o.doctype || {}, q = a.navigator.userAgent, r = a.createObjectURL && a || a.URL && URL.revokeObjectURL && URL || a.webkitURL && webkitURL, s = a.Blob, t = a.File, u = a.FileReader, v = a.FormData, w = a.XMLHttpRequest, x = a.jQuery, y = !(!(t && u && (a.Uint8Array || v || w.prototype.sendAsBinary)) || /safari\//i.test(q) && !/chrome\//i.test(q) && /windows/i.test(q)), z = y && "withCredentials"in new w, A = y && !!s && !!(s.prototype.webkitSlice || s.prototype.mozSlice || s.prototype.slice), B = a.dataURLtoBlob, C = /img/i, D = /canvas/i, E = /img|canvas/i, F = /input/i, G = /^data:[^,]+,/, H = a.Math, I = function (b) {
        return b = new a.Number(H.pow(1024, b)), b.from = function (a) {
            return H.round(a * this)
        }, b
    }, J = {}, K = [], L = "abort progress error load loadend", M = "status statusText readyState response responseXML responseText responseBody".split(" "), N = "currentTarget", O = "preventDefault", P = function (a) {
        return a && "length"in a
    }, Q = function (a, b, c) {
        if (a)if (P(a))for (var d = 0, e = a.length; e > d; d++)d in a && b.call(c, a[d], d, a); else for (var f in a)a.hasOwnProperty(f) && b.call(c, a[f], f, a)
    }, R = function (a) {
        ...
        if (a) {
            var d = X.uid(a), e = J[d] || {}, f = u && a && a instanceof u;
            Q(b.split(/\s+/), function (b) {
        ...
        readAsImage: function (a, d, e) {
            ...
            }); else if (X.isCanvas(a))c(a, d, "load", a); else if (C.test(a.nodeName))if (a.complete)c(a, d, "load", a); else {
        ...
        getDropFiles: function (a, b) {
            var c = [], d = k(a), e = P(d.items) && d.items[0] && g(d.items[0]), i = X.queue(function () {
                b(c)
            });
        ...
        upload: function (a) {
            ...
            var b, c = new X.XHR(a), d = this._getFilesDataArray(a.files), e = this, f = 0, g = 0, h = !1;
        ...
        _getFilesDataArray: function (a) {
            ...
            }), b.length || b.push({file: {name: X.expando}}), b
        },
        _getFormData: function (a, b, c) {
            var d = b.file, e = b.name, f = d.name, g = d.type, h = X.support.transform && a.imageTransform, i = new X.Form, j = X.queue(function () {
                c(i)
            }), k = h && l(h), m = X.postNameConcat;
            Q(a.data, function n(a, b) {
                ...
                b.image ? (j.inc(), b.toData(function (a, b) {
                    ...
                    if (k && !c)B || X.flashEngine || (i.multipart = !0), i.append(e, d[0], f, h[0].type || g); else {
                        var l = 0;
                        c || Q(d, function (a, b) {
    ...
    e.prototype = {
        status: 0, statusText: "", constructor: e, getResponseHeader: function (a) {
            ...
            if (b.log("XHR._send:", e), c.cache || (j += (~j.indexOf("?") ? "&" : "?") + b.uid()), e.nodeName) {
                ...
                var l = g.getElementsByTagName("form")[0], m = g.getElementsByTagName("iframe")[0];
                ...
                h.xhr.abort = function () {
                    ...
                    try {
                        var a = m.contentWindow, c = a.document, d = a.result || b.parseJSON(c.body.innerHTML);
                ...
                if (g = h.xhr = b.getXHR(), e.params && (j += (j.indexOf("?") < 0 ? "?" : "&") + e.params.join("&")), g.open("POST", j, !0), b.withCredentials && (g.withCredentials = "true"), c.headers && c.headers["X-Requested-With"] || g.setRequestHeader("X-Requested-With", "XMLHttpRequest"), b.each(c.headers, function (a, b) {
                    ...
                    var p = e.file, q = (p.slice || p.mozSlice || p.webkitSlice).call(p, e.start, e.end + 1);
                    ...
                    if (g.sendAsBinary)g.sendAsBinary(r); else {
                    ...
                    getFiles: function (a, b, d) {
                        ...
                        if (k(a))this.parent.apply(this, arguments); else if (a.isShot)b(null, a.info = {
                            ...
                            if (!a.__info) {
                                ...
                                v.cmd(a, "getFileInfo", {
                                    id: a.id, callback: l(function e(b, c) {
